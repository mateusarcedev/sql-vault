...
const ROUTINE_TYPE_OPTIONS: { value: RoutineType; icon: any }[] = [
  { value: 'function', icon: FunctionSquare },
  { value: 'procedure', icon: GitBranch },
  { value: 'trigger', icon: Zap },
  { value: 'view', icon: Eye },
]

function RoutineListContent() {
  const t = useTranslations('routines')
  const tQueries = useTranslations('queries')
  ...
  return (
    <>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            >
              <SelectTrigger className="w-40">
                <SelectValue placeholder={tQueries('database')} />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="all">{tQueries('allDatabases')}</SelectItem>
            ...
            >
              <SelectTrigger className="w-44">
                <SelectValue placeholder={t('routineType')} />
              </SelectTrigger>
              <SelectContent>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="w-48">
                <DropdownMenuLabel>{tQueries('filterByTag')}</DropdownMenuLabel>
                <DropdownMenuSeparator />
                {tags.map((tag) => (
                  <DropdownMenuCheckboxItem
                    key={tag.id}
          ...
          {isLoading ? (
            ...
            <Empty className="border">
              <EmptyHeader>
                ...
                <EmptyTitle>{t('noRoutinesFound')}</EmptyTitle>
                <EmptyDescription>
                  {hasFilters
      ...
      <DeleteConfirmModal
        ...
        title={t('deleteTitle')}
        description={t('deleteDescription', { name: deletingRoutine?.name ?? '' })}
